...
function Game()
{
    ...
    const handleRoll = async (event) => {
        ...
        try {
            setRollAnim(true)
            const { data } = await axios.post("/roll/6/3/" + user_id + "/").catch((err) => { logout(); });
            await sleep(1000)
            setRolls(data.rolls)
            setRollAnim(false)
    ...
    return (
        <div className="GamePage">
            <div className="NavBar">
                ...
                <div className="Logout">
                    <Button
                        ...
                        style={{ backgroundColor: but_color}}>Logout</Button>
            ...
            <div className="DiceWrapper">
                <div className="DiceDiv">
                    {rolls.map((roll,index) => (
                        <img className={"Dice" + (roll_anim ? " DiceAnim" : "")} src={dice_paths[roll - 1]} alt="" key={index}/>
                    ))}
                </div>
            ...
            <Button
                ...
                color="primary"
                onClick={handleRoll}
                style={{ backgroundColor: but_color, width: '100px', height: '50px', fontSize: '1.5em'}}>Roll</Button>
            </div>
                ...
                <div className="LeadboardDiv AllTimeDiv">
                    ...
                    <div className="LeaderboardScroll">
                        {all_time_leaderboard.map((data,index) => (
                            <div className={"LeaderboardRow" + (index % 2 ? " EvenRow": " OddRow")} key={index}>
